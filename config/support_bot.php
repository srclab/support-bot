...
return [
    ...
    /*
     ...
     | клиентом после его обращения в поддержку. Пример: для уточнения смог ли
    ...
    'scripts' => [
        ...
        'clarfication_message' => 'Здравствуйте!🤗
            Не так давно вы обращались к нам для выполнения задания
            Удалось ли вам разместить заказ на сайте?
            Если нет, мы можем помочь вам с размещением заказа – напишите нам',
        'clarfication_select_message' => '(?:https://vse-sdal.com/promo|https://vse-sdal.com/onlajn-pomoshch|http://taplink.cc/vsesdal_official)',
    ],
